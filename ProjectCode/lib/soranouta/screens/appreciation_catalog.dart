...
class AppreciationMovie {
  ...
  String get thumbnailAsset => 'backgrounds/$thumbnailBackgroundId.webp';
}
...
const appreciationCharacters = <AppreciationCharacter>[
  ...
  if (SoranoutaReleaseConfig.chapter2Released)
    AppreciationCharacter(
      id: 'xiayo2',
      name: '夏悠（第二章）',
      poses: <String>[
...
const appreciationCgs = <AppreciationCg>[
  ...
  if (SoranoutaReleaseConfig.chapter2Released) ...<AppreciationCg>[
    AppreciationCg.composite(
      title: '池畔戏水',
...
const appreciationMovies = <AppreciationMovie>[
  AppreciationMovie(
    id: 'op',
    title: '《空之歌》Opening Movie',
    movieFile: 'OP.mp4',
    duration: Duration(milliseconds: 87284),
    thumbnailBackgroundId: 'sky',
  ),
];
...
const appreciationMusic = <AppreciationMusic>[
  ...
  if (SoranoutaReleaseConfig.chapter3Released)
